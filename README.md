This Hangman game is a simple command-line version of the classic word-guessing game. Players try to guess the letters of a hidden word, with a limited number of incorrect guesses allowed.
